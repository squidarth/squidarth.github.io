...
we got started with the basics, and with Kevin, where we worked on solving [problems in concurrency](https://github.com/data-pup/dining-philosophers)
...
This has been a very different experience from other programming
languages that I've learned in the past--and a lot of that has
been a consequence of being at RC. When I was learning Ruby, Python,
and JS for my last couple jobs, my main priority was figuring out how
to be productive as quickly as possible. The fastest path to being productive
is understanding the happy cases of the language very well, and the
patterns used in common frameworks like Ruby on Rails.

Programming language designers, on the other hand, have a very different mentality
towards analyzing new programming languages. Notably, they tend to not
just be interested in the "happy paths" in a programming language, but
also the edges of the language. For a statically-typed language like Rust,
...
The work that Adam Palay, another Recurser, has done in trying to implement
the [SKI combinator](https://en.wikipedia.org/wiki/SKI_combinator_calculus)
in a couple different statically typed languages definitely inspired me
to be more rigorous with regards to type systems.

Towards this end, I've tried to take a more rigorous approach towards understanding
some of the harder language features of Rust, and tried to not gloss over questions
I've had.
...
and doing some projects to further my mathematical maturity.

I'm also excited to pair with Lucy this coming week on a [FFT](https://en.wikipedia.org/wiki/Fast_Fourier_transform)-related project, and to
finish up the DNS resolver and SSH implementation that I've been working on with Rory
and Elad.

Thanks for reading and making it this far! Stay tuned for more random musings.
